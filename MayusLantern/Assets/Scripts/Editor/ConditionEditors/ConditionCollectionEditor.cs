...
public class ConditionCollectionEditor : EditorWithSubEditors<ConditionEditor, Condition>
{
    ...
    private SerializedProperty reactionsCollectionsProperty;
    ...
    private void OnEnable()
    {
        ...
        reactionsCollectionsProperty = serializedObject.FindProperty(conditionCollectionPropReactionCollectionName);
    ...
    private void ExpandedGUI()
    {
        ...
        EditorGUILayout.PropertyField(reactionsCollectionsProperty);
    }
