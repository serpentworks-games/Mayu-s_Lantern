...
[CustomEditor(typeof(TriggerInteractable))]
public class TriggerInteractableEditor : EditorWithSubEditors<ConditionCollectionEditor, ConditionCollection>
{
    private TriggerInteractable interactable;
    ...
    {
        interactable = (TriggerInteractable)target;
